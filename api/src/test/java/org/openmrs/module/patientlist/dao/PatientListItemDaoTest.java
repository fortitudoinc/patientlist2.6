 ...
 */
package org.openmrs.module.patientlist.dao;
 ...
 */
public class PatientListItemDaoTest extends BaseModuleContextSensitiveTest {
	...
	public void savePatientListItem_shouldSaveAllPropertiesInDb() {
		//Given
		PatientListItem item = new PatientListItem();
		
		//When
		dao.savePatientListItem(item);
